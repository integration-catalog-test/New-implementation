...
objectClass("User") {
    ...
    attribute("avatar") {
        ...
        readable true;
        returnedByDefault true;
        description "URL to userâs avatar";
    }
    ...
    attribute("identity_url") {
        ...
        readable true;
        returnedByDefault true;
        description "Userâs identity_url for OmniAuth authentication";
    }
    attribute("language") {
        jsonType "string";
        creatable true;
    ...
    attribute("login") {
        ...
        returnedByDefault true;
        required true;
        description "Userâs login name";
    }
    //TODO association ....
...
//    }
    attribute("name") {
        ...
        readable true;
        returnedByDefault true;
        description "Userâs full name, formatting depends on instance settings";
    }
    attribute("password") {
        jsonType "string";
        updateable true;
        ...
        description "Userâs password for the default password authentication";
    }
    //TODO complex type??? ....
//    attribute("status") {
//        jsonType "status";
